  ...
  return <div>
    <header className="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
      ...
      <ul className="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
        <li className="nav-item px-2">Score: {props.currentScore}</li>
        <li className="nav-item px-2">High Score: {props.highScore}</li>
      </ul>
      <div className="text-end">
        <button type="button" className="btn btn-outline-primary me-2">Rules</button>
        <button type="button" className="btn btn-outline-primary me-2">Change Difficulty</button>
